...
REM DATE TWO WEEKS AGO YYYY-MM-DD is: `+ twoweeksago_date_YYYYMMDD +`

`+ twomonthslater_date_YYYYMMDD +`

REM DATE TWO MONTHS FROM NOW YYYY-MM-DD is: `+ twomonthslater_date_YYYYMMDD +`
...
function macrobody(tonight_billdate_YYYYMMDD,
  ...
  return `
   ...
   autECLSession.autECLPS.Wait 950 
   ...
   autECLSession.autECLPS.Wait 962 
   ...
   autECLSession.autECLPS.SendKeys "[tab]"
   autECLSession.autECLOIA.WaitForInputReady
   autECLSession.autECLPS.SendKeys "SI1"
   autECLSession.autECLOIA.WaitForInputReady
   autECLSession.autECLPS.SendKeys "[tab]"
   autECLSession.autECLOIA.WaitForInputReady
   ...
   autECLSession.autECLPS.Wait 937
   ...
   autECLSession.autECLPS.WaitForAttrib 4,22,"10","3c",3,10000

   autECLSession.autECLPS.WaitForCursor 4,23,10000
   ...
   autECLSession.autECLOIA.WaitForInputReady
   autECLSession.autECLPS.SendKeys "EMVLOWE"
   autECLSession.autECLOIA.WaitForInputReady
   autECLSession.autECLPS.SendKeys "[enter]"
   
   autECLSession.autECLPS.WaitForAttrib 4,22,"10","3c",3,10000

   autECLSession.autECLPS.Wait 1829 
   ...
   autECLSession.autECLPS.Wait 1203 
   ...
   autECLSession.autECLPS.WaitForAttrib 4,26,"10","3c",3,10000

   autECLSession.autECLPS.WaitForCursor 4,27,10000
   ...
   autECLSession.autECLPS.SendKeys "[delete]"
   autECLSession.autECLOIA.WaitForInputReady
   autECLSession.autECLPS.SendKeys "`+ twoweeksago_date_YYYYMMDD +`"
   autECLSession.autECLOIA.WaitForInputReady
   autECLSession.autECLPS.SendKeys "[backtab]"
   autECLSession.autECLOIA.WaitForInputReady
   autECLSession.autECLPS.SendKeys "[tab]"
   ...
   autECLSession.autECLPS.SendKeys "[delete]"
   autECLSession.autECLOIA.WaitForInputReady
   autECLSession.autECLPS.SendKeys "`+ twomonthslater_date_YYYYMMDD +`"
   autECLSession.autECLOIA.WaitForInputReady
   autECLSession.autECLPS.SendKeys "[pf21]"
