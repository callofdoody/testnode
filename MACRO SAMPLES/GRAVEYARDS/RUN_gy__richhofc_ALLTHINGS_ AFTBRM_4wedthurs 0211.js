...
REM Yesterdays date MMDDYYYY is: 02102021

REM TUES date MMDDYYYY is: 02092021

REM MON date MMDDYYYY is: 02082021

REM Today OUTQ is: OUTQ4

REM Prev Day OUTQ is: OUTQ3

REM Two Biz Days Ago OUTQ is: OUTQ2
...
sub subSub1_()
   ...
   autECLSession.autECLOIA.WaitForInputReady
   autECLSession.autECLPS.SendKeys "MOVOUTQ FRMOUTQ(PDSYLIB000/OUTQ4) TOOUTQ(QGPL/QPRINTS) SPLFNM(SYOZ31)"
   autECLSession.autECLOIA.WaitForInputReady
   autECLSession.autECLPS.SendKeys "[enter]"
   ...
   autECLSession.autECLOIA.WaitForInputReady
   autECLSession.autECLPS.SendKeys "MOVESPLF PDSYLIB000/OUTQC PDSYLIB000/OUTQ4"
   autECLSession.autECLOIA.WaitForInputReady
   autECLSession.autECLPS.SendKeys "[enter]"
   ...
   autECLSession.autECLOIA.WaitForInputReady
   autECLSession.autECLPS.SendKeys "MOVESPLF PDSYLIB000/OUTQB PDSYLIB000/OUTQ2 PERIOD((*AVAIL) (175959 02092021))"
   autECLSession.autECLOIA.WaitForInputReady
   autECLSession.autECLPS.SendKeys "[enter]"
   ...
   autECLSession.autECLOIA.WaitForInputReady
   autECLSession.autECLPS.SendKeys "MOVESPLF PDSYLIB000/OUTQB PDSYLIB000/OUTQ3 PERIOD((*AVAIL) (175959 02102021))"
   autECLSession.autECLOIA.WaitForInputReady
   autECLSession.autECLPS.SendKeys "[enter]"
