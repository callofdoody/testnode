...
REM TUESDAY Macro Date MMDDYYYY is: SCDDATE(02092021)

REM WEDNESDAY Macro Date MMDDYYYY is: SCDDATE(02102021)

REM THURSDAY Macro Date MMDDYYYY is: SCDDATE(02112021)

REM FRIDAY Macro Date MMDDYYYY is: SCDDATE(02122021)



REM TUESDAY Daily SCDBatch is: JOBQ(SCDBATCH2)

REM TUESDAY Daily OUTQ is: OUTQ2

REM WEDNESDAY Daily SCDBatch is: JOBQ(SCDBATCH3)

REM WEDNESDAY Daily OUTQ is: OUTQ3

REM THURSDAY Daily SCDBatch is: JOBQ(SCDBATCH4)

REM THURSDAY Daily OUTQ is: OUTQ4

REM FRIDAY Daily SCDBatch is: JOBQ(SCDBATCH5)

REM FRIDAY Daily OUTQ is: OUTQ5
...
sub subSub1_()
   ...
   autECLSession.autECLOIA.WaitForInputReady
   autECLSession.autECLPS.SendKeys "SCDDATE(02092021) JOBQ(SCDBATCH2) SCDTIME(050000)"
   autECLSession.autECLOIA.WaitForInputReady
   autECLSession.autECLPS.SendKeys "[backtab]"
   autECLSession.autECLOIA.WaitForInputReady
   autECLSession.autECLPS.SendKeys "[backtab]"
   ...
   autECLSession.autECLOIA.WaitForInputReady
   autECLSession.autECLPS.SendKeys "SCDDATE(02102021) JOBQ(SCDBATCH3) SCDTIME(050000)"
   autECLSession.autECLOIA.WaitForInputReady
   autECLSession.autECLPS.SendKeys "[backtab]"
   autECLSession.autECLOIA.WaitForInputReady
   autECLSession.autECLPS.SendKeys "[backtab]"
   ...
   autECLSession.autECLOIA.WaitForInputReady
   autECLSession.autECLPS.SendKeys "SCDDATE(02112021) JOBQ(SCDBATCH4) SCDTIME(050000)"
   autECLSession.autECLOIA.WaitForInputReady
   autECLSession.autECLPS.SendKeys "[backtab]"
   autECLSession.autECLOIA.WaitForInputReady
   autECLSession.autECLPS.SendKeys "[backtab]"
   ...
   autECLSession.autECLOIA.WaitForInputReady
   autECLSession.autECLPS.SendKeys "SCDDATE(02122021) JOBQ(SCDBATCH5) SCDTIME(050000)"
   autECLSession.autECLOIA.WaitForInputReady
   autECLSession.autECLPS.SendKeys "[backtab]"
   autECLSession.autECLOIA.WaitForInputReady
   autECLSession.autECLPS.SendKeys "[backtab]"
