...
const fs = require('fs')
const macro = require('./macros/macromainGVY')
...
*/
  ...
  GY_SCD(exempt_list, macro.scd_cgy(), numdates.NUMDATE_DAY_MON+"To"+numdates.NUMDATE_DAY_FRI,dates.THISWEEK_MON_MMDD()+"-"+
  ...
  GY_SCD(exempt_list, macro.scd_vanbby(), numdates.NUMDATE_DAY_MON+"To"+numdates.NUMDATE_DAY_FRI,dates.THISWEEK_MON_MMDD()+"-"+
  dates.THISWEEK_FRI_MMDD(),
  false,
  mon_scd, tue_scd, wed_scd, thr_scd, fri_scd, 
    mon_outq, tue_outq, wed_outq, thr_outq, fri_outq,
...
function GY_SCD(exempt_list, macro_obj, today_numdate, today_MMDD, has_gwarning,
mon_scd, tue_scd, wed_scd, thr_scd, fri_scd, 
  mon_outq, tue_outq, wed_outq, thr_outq, fri_outq,
  mon_macrodate_MMDDYYYY, 
  tue_macrodate_MMDDYYYY, 
  ...
  thr_macrodate_MMDDYYYY, 
  fri_macrodate_MMDDYYYY, filelist, filenames) {
  var fname = macro_obj.filename(MACROSERIES+"_"+GVY_SHIFT, today_numdate,
    today_MMDD + (has_gwarning ? "_GWARN_": "")
    )
  var variables = macro_obj.variables(exempt_list, has_gwarning, mon_scd, tue_scd, wed_scd, thr_scd, fri_scd, 
  mon_outq, tue_outq, wed_outq, thr_outq, fri_outq,
  mon_macrodate_MMDDYYYY, 
  tue_macrodate_MMDDYYYY, 
  wed_macrodate_MMDDYYYY, 
  ...
  var macrobody = macro_obj.macrobody(exempt_list, has_gwarning, mon_scd, tue_scd, wed_scd, thr_scd, fri_scd, 
  mon_outq, tue_outq, wed_outq, thr_outq, fri_outq,
  mon_macrodate_MMDDYYYY, 
  tue_macrodate_MMDDYYYY, 
  wed_macrodate_MMDDYYYY, 
...
function CGY_DAY_CHECKLIST(today_numdate, today_MMDD, today_YYYYMMDD, yesterday_YYYYMMDD,firstofmonth_billdate_YYYYMMDD, outq, filelist, filenames) {
  var fname = macro.dailylist_cgy().filename(MACROSERIES+"_"+GVY_SHIFT, today_numdate,
    today_MMDD)
...
function CGY_FRIDAY_CHECKLIST(today_numdate, today_MMDD, today_YYYYMMDD, yesterday_YYYYMMDD,firstofmonth_billdate_YYYYMMDD, outq, filelist, filenames) {
  var fname = macro.dailylist_cgyFRI().filename(MACROSERIES+"_"+GVY_SHIFT, today_numdate + numdates.ENDOFWEEK,
    today_MMDD)
...
function VANBBY_DAY_CHECKLIST(today_numdate, today_MMDD, today_billdate_YYYYMMDD,
  ...
  var fname = macro.dailylist_vanbby().filename(MACROSERIES+"_"+GVY_SHIFT, today_numdate,
    today_MMDD)
...
function VANBBY_FRIDAY_CHECKLIST(today_numdate, today_MMDD, today_billdate_YYYYMMDD,
  ...
  var fname = macro.dailylist_vanbbyFRI().filename(MACROSERIES+"_"+GVY_SHIFT, today_numdate + numdates.ENDOFWEEK,
    today_MMDD)
...
function HOFC_FULLCHECKLIST(today_numdate, macrodate_MMDD, prevdate_MMDDYYYY, today_outq, filelist, filenames) {
  var fname = macro.hofc_FULLCHECKLIST().filename(MACROSERIES+"_"+GVY_SHIFT, today_numdate, macrodate_MMDD)
...
function RICHHOFC_FULLCHECKLIST(today_numdate, macrodate_MMDD, prevdate_MMDDYYYY, twobizdaysbefore_MMDDYYYY, 
  ...
  var fname = macro.richhofc_FULLCHECKLIST().filename(MACROSERIES+"_"+GVY_SHIFT, today_numdate, macrodate_MMDD)
...
function VANDIVS_FULLCHECKLIST(today_numdate, macrodate_MMDD, prevdate_MMDDYYYY, yesterday_outq, filelist, filenames) {
  var fname = macro.vandivs_FULLCHECKLIST().filename(MACROSERIES+"_"+GVY_SHIFT, today_numdate, macrodate_MMDD)
...
function MVALLSPLOUTQS(macro_obj, numdate, macrodate_MMDD, 
  ...
  var fname = macro_obj.filename(MACROSERIES+"_"+GVY_SHIFT, numdate, macrodate_MMDD)
...
function HOFC_CREATEOUTQS_NEXTWK(filelist, filenames) {
  var fname_hofc = macro.macros_hofc_createoutqs_nextwk().filename(MACROSERIES+"_"+GVY_SHIFT,
    dates.NEXTWEEK_MON_MMDD(),
    dates.NEXTWEEK_SAT_MMDD())
